        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_FOOT_UPDATE: {
                    float x = Real2Map(msg.getData().getFloat(WalkCounter.FOOT_CURRENTX));
                    float y = 0 - Real2Map(msg.getData().getFloat(WalkCounter.FOOT_CURRENTY));
...
//                    }
                ...
                case MSG_STEP_UPDATE: {
                    float x = Real2Map(msg.getData().getFloat(WalkCounter.FOOT_CURRENTX));
                    float y = 0 - Real2Map(msg.getData().getFloat(WalkCounter.FOOT_CURRENTY));
                    int num = msg.getData().getInt(WalkCounter.STEP_COUNT);
...
//        }
    ...
    protected void drawStepNum(Canvas canvas) {
        ...
        String informationStr = "Walking Route";
